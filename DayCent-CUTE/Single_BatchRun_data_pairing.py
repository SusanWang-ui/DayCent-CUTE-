...
def run(i):
    ...
    parm.pairdCal = [0 for x in range(len(parm.DayCent_var))]
    parm.pairpCal = [0 for x in range(len(parm.DayCent_var))]
    parm.pairoCal = [0 for x in range(len(parm.DayCent_var))]
    parm.pairdVal = [0 for x in range(len(parm.DayCent_var))]
    parm.pairpVal = [0 for x in range(len(parm.DayCent_var))]
    parm.pairoVal = [0 for x in range(len(parm.DayCent_var))]
